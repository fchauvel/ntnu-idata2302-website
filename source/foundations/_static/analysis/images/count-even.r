...
svglite::svglite(filename = "count_even.svg", width = 6, height = 5);
...
svglite::svglite(filename = "count_even_full.svg", width = 6, height = 6);
...
legend("topleft", inset=0.05,
       legend=c("worse case K=n", "best case K=0", "average case K = n/2", "random samples"),
       box.lty=0,
